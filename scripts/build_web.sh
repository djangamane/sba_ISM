...
STRIPE_CHECKOUT_MONTHLY=${STRIPE_CHECKOUT_MONTHLY:-}
STRIPE_CHECKOUT_ANNUAL=${STRIPE_CHECKOUT_ANNUAL:-}
EOF
...
flutter build web --release \
  ...
  --dart-define=STRIPE_CHECKOUT_MONTHLY="${STRIPE_CHECKOUT_MONTHLY:-}" \
  --dart-define=STRIPE_CHECKOUT_ANNUAL="${STRIPE_CHECKOUT_ANNUAL:-}"
